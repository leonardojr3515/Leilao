...
public class ListaLeilaoActivity extends AppCompatActivity {
    ...
    private List<Leilao> leiloesDeExemplo() {
        ...
        console.propoe(new Lance(new Usuario("Leonardo"), 200.0));
        console.propoe(new Lance(new Usuario("Anna Caroline"), 300.0));

        Leilao computador = new Leilao("Computador");
        console.propoe(new Lance(new Usuario("Junior"), 15000.0));

        Leilao carro = new Leilao("Carro");
        console.propoe(new Lance(new Usuario("Leonardo"), 20000.0));
        console.propoe(new Lance(new Usuario("Anna Caroline"), 30000.0));
        console.propoe(new Lance(new Usuario("Junior"), 50000.0));
